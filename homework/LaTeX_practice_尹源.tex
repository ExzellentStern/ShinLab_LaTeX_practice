...
\begin{figure}[H]
    \centering
    \practiceimage[4cm]{figures/photo1.jpg}
    \caption{演習用に挿入した画像}
    \label{fig:kirby}
\end{figure}
...
\begin{strip}
    ...
    \begin{minipage}{0.44\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=45mm,keepaspectratio]{figures/photo2.jpg}
        \subcaption{画像1}
        \label{fig:wide1}
    \end{minipage}
    \hfill
    \begin{minipage}{0.44\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=45mm,keepaspectratio]{figures/photo3.jpg}
        \subcaption{画像2}
        \label{fig:wide2}
    \end{minipage}
