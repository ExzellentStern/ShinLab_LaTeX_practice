...
\begin{abstract}
本稿では、LaTeXを用いた基本的な文書作成の演習結果について報告する。
具体的には、数式、図表、箇条書き、ソースコードなどの挿入方法を実践し、
実際の論文作成に必要な基礎技術の習得を目指す。
\end{abstract}
...
\begin{equation}
\oint_{C} \vect{F} \cdot \dif\vect{r}
\end{equation}

\begin{equation}
\oint_{C} \frac{1}{z - a} \, \dif z = 2\pi \ii
\end{equation}

$\oint_C \bm{F} \cdot \mathrm{d}\bm{r}$

$\oint_C \frac{1}{z-a} \, \mathrm{d}z = 2\pi\mathrm{i}$
...
\begin{table}[H]
    \centering
    \caption{演習で作成した5行7列の表}
    \label{tab:my_table_5x7}
    \resizebox{\linewidth}{!}{% 表を1段の幅に収める設定
        \begin{tabular}{|c|c|c|c|c|c|c|}
            \hline
            回数 & データA & データB & データC & データD & データE & 判定 \\ \hline
            1    & 10.5    & 20.3    & 30.1    & 40.8    & 50.2    & OK   \\ \hline
            2    & 11.2    & 19.8    & 29.5    & 41.2    & 49.7    & OK   \\ \hline
            3    & 9.8     & 21.5    & 31.0    & 39.5    & 51.3    & NG   \\ \hline
            4    & 10.1    & 20.0    & 30.2    & 40.1    & 50.0    & OK   \\ \hline
        \end{tabular}%
    }
\end{table}
